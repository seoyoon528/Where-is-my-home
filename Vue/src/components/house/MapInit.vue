...
export default {
  ...
  methods: {
    initMap() {
      ...
      var imageSrc = "https://cdn-icons-png.flaticon.com/512/4551/4551325.png",
        imageSize = new kakao.maps.Size(55, 58);
    ...
    onClickCategory(ev) {
      console.log("카테고리 버튼 눌림", ev.target);
      var id = ev.target.id,
      ...
      if (className === "on") {
        this.currCategory = "";
        this.changeCategoryClass(ev.target.children);
        this.removeMarker();
      } else {
